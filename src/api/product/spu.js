...
// 获取平台全部吸收属性 -- 整个平台销售属性一共三个
// /admin/product/baseSaleAttrList  get
export const reqBaseSaleAttrList = () => request({url: `/admin/product/baseSaleAttrList`, method: 'get'});

// 修改 SPU || 添加 SPU：对于修改或者添加，携带给服务器参数大致一样的，唯一的区别就是携带的参数是否带 id
...
export const reqAddSku = (skuInfo) => request0({url: '/admin/product/saveSpuInfo', method: 'post', data: skuInfo});
